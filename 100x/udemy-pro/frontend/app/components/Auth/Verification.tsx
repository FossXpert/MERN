  ...
  useEffect(()=>{
    ...
    if(error){
      if("data" in error){
        ...
        console.log("An Error occured in verification.tsx",error)
      }
    }
  },[isSuccess,error]);
  ...
  return (
    <div>
      ...
      <h5 className='text-center pt-4 font-Poppins text-[14px] text-black dark:text-white'>
        Go Back To SignIn ? <span className='text-[#2190ff] pl-1 cursor-pointer'
        onClick={()=>setRoute('signin')}>Sign In</span>
      </h5>
    </div>
  )
}
